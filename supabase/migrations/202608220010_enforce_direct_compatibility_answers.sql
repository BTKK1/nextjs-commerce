-- Make binary product-fit answers unambiguous across every merchant agent.
-- Model selection remains unchanged and the atomic function records the
-- Founder-authored global behavior update in the audit trail.
